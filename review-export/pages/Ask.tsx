      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-24">
        ...
        <div className="mt-8 bg-white/5 backdrop-blur-sm rounded-xl p-4 border border-white/10 max-w-lg mx-auto">
          <p className="text-center text-white/80 text-sm">
            {language === 'en'
              ? "ezLegal.ai provides legal information to help you understand your situation. We are not a law firm and this is not legal advice. If you need an attorney, we'll help you find one - free."
              : "ezLegal.ai proporciona información legal para ayudarte a entender tu situación. No somos un bufete de abogados y esto no es asesoramiento legal."
            }
          </p>
        </div>
      </div>
