        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center max-w-4xl mx-auto">
            <div className="inline-flex items-center gap-2 bg-white/15 border border-white/30 px-4 py-2 rounded-full mb-6 backdrop-blur-sm">
              ...
              <span className="text-sm font-semibold text-white">AI-Powered Legal Tools for Everyone</span>
            </div>
            ...
            <p className="text-sm text-white/80 mt-6 flex items-center justify-center gap-4 flex-wrap">
              <span className="flex items-center gap-1.5"><CheckCircle className="w-4 h-4 text-success-400" aria-hidden="true" /> 30-day money-back guarantee</span>
              <span className="flex items-center gap-1.5"><CheckCircle className="w-4 h-4 text-success-400" aria-hidden="true" /> No credit card required</span>
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
            <div className="text-center">
              <div className="text-4xl font-bold text-teal-600 mb-1">Free</div>
              <p className="text-navy-600 text-sm">Unlimited Questions</p>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-teal-600 mb-1">Instant</div>
              <p className="text-navy-600 text-sm">AI Responses</p>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              ...
              <p className="text-navy-600 text-sm">Legal Topics</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-navy-50 border-b border-navy-200">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            <h2 className="text-2xl sm:text-3xl font-bold text-navy-900 mb-2">How It Works</h2>
            <p className="text-navy-600">From question to resolution in four clear steps</p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-navy-600 max-w-2xl mx-auto">
              Comprehensive legal tools designed to help you understand your situation and make informed decisions.
            </p>
          </div>
