...
export const pricingAudiences: PricingAudience[] = [
  ...
  },
  {
    ...
    plans: [
      ...
      {
        id: 'coalition',
        name: { en: 'Coalition', es: 'Coalición' },
        audience: 'legal-aid',
        price: { en: 'Custom', es: 'Personalizado' },
        isFinalPrice: true,
        ...
        ctaLabel: { en: 'Build a coalition', es: 'Construir una coalición' },
        ctaHref: '/schedule-demo',
      },
      {
        id: 'enterprise-gov',
...
export const pricingFAQ = [
  {
    ...
    a: {
      ...
      es: 'No. ezLegal.ai es una herramienta de información legal impulsada por IA. Te ayudamos a entender situaciones legales, documentos y próximos pasos, pero no somos un bufete de abogados y no proporcionamos asesoramiento ni representación legal.',
    },
  },
  {
    ...
    a: {
      ...
      es: 'No. Proporcionamos información legal en lenguaje simple. Para asesoramiento legal específico a tu situación, consulta con un abogado licenciado. Podemos ayudarte a prepararte para esa conversación.',
    },
  },
  {
  ...
  },
  {
    ...
    a: {
      ...
      es: 'Sí. ezLegal.ai funciona en inglés y español. Puedes hacer preguntas, subir documentos y recibir orientación en cualquier idioma.',
    },
  },
  {
    ...
    a: {
      ...
      es: 'Sí. Cuando necesitas ayuda legal profesional, podemos conectarte con organizaciones de ayuda legal, servicios pro bono, o abogados verificados en tu área.',
    },
  },
  {
    q: { en: 'How do legal-aid organizations use this?', es: '¿Cómo usan esto las organizaciones de ayuda legal?' },
    a: {
      ...
      es: 'Las organizaciones de ayuda legal pueden usar ezLegal.ai para soporte de admisión, herramientas de autoayuda multilingües, revisión de documentos, triaje y enrutamiento de referencias. Las organizaciones calificadas pueden acceder sin costo.',
    },
  },
  {
  ...
  {
    q: { en: 'How do referrals work?', es: '¿Cómo funcionan las referencias?' },
    a: {
      ...
      es: 'Las referencias gratuitas de ayuda legal se basan en tus necesidades y ubicación. Las referencias profesionales de pago, si están disponibles, están claramente etiquetadas y deben cumplir nuestros estándares de idoneidad y ética.',
    },
  },
];
