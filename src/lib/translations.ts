...
export const translations: Record<Language, Record<string, string>> = {
  ...
  en: {
    ...
    'features.aiMatch.desc': 'Get instant AI answers PLUS browse attorney profiles by practice area. Chat with AI, view lawyer directories, and request consultations - all in one place.',
    ...
    'footer.verificationText': 'Sources cross-referenced with official databases every 30 days',
    ...
    'article.needGuidance': 'Need personalized legal information?',
    ...
    'dash.aiLawyerMatchDesc': 'AI answers + browse attorney directory',
  ...
  es: {
    ...
    'features.aiMatch.desc': 'Obtén respuestas instantáneas de IA más abogados compatibles al instante. Chatea con IA, busca abogados reales y reserva consultas, todo en un solo lugar.',
    ...
    'cta.subtitle': 'Comienza tu prueba gratis y obtén respuestas en minutos.',
    ...
    'footer.legalNoticeText': 'No somos un bufete de abogados, y el uso de este servicio no crea una relación abogado-cliente. Sus comunicaciones con ezLegal.ai no están protegidas por el privilegio abogado-cliente. Para asuntos complejos, representación en corte, o asesoramiento legal personalizado, consulte con un abogado licenciado en su jurisdicción.',
    ...
    'features.overview.ai.desc': 'Obtén respuestas instantáneas a tus preguntas legales 24/7',
    ...
    'signup.benefit4Desc': 'Tus datos están encriptados y nunca se usan para entrenar modelos de IA. Infraestructura certificada SOC 2.',
