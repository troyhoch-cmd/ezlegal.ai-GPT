          ...
          <div className="text-center max-w-3xl mx-auto">
            <div className="inline-flex items-center gap-2 bg-white/15 backdrop-blur-sm px-4 py-2 rounded-full mb-6 border border-white/30">
              ...
              <span className="text-sm font-semibold text-white">
                {en ? 'Making Legal Information Accessible with AI' : 'Haciendo la Información Legal Accesible con IA'}
              </span>
            </div>
            <h1 className="text-4xl sm:text-5xl font-bold mb-6 leading-tight text-white">
              {en ? 'Legal Assistance for Everyone Who Needs It' : 'Asistencia Legal Para Todos Los Que La Necesitan'}
            </h1>
            <p className="text-lg sm:text-xl text-white/90 leading-relaxed mb-10">
              {en
                ...
                : 'Nuestra misión es hacer que la información legal sea accesible y asequible para individuos, familias, pequeños negocios y organizaciones pro bono a través del poder de la IA.'}
            </p>
