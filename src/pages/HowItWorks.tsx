...
export default function HowItWorks() {
  ...
  const sections = [
    ...
    { id: 'rag-demo', label: 'AI Demo' },
    { id: 'sources', label: 'Sources' },
    { id: 'jurisdiction', label: 'Jurisdiction' },
    { id: 'attorney-review', label: 'Review' },
    { id: 'safety', label: 'Safety' },
    { id: 'citation-policy', label: 'Citations' },
    { id: 'hallucination-mitigation', label: 'Accuracy' },
    { id: 'escalation-logic', label: 'Escalation' },
    { id: 'privacy-handling', label: 'Privacy' },
  ];
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-4xl mx-auto">
              <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full mb-6 border border-white/20">
                ...
                <span className="text-sm font-semibold">AI Methodology</span>
              </div>
              <h1 className="text-4xl lg:text-5xl font-bold mb-6">
                How Our AI Works
              </h1>
              <p className="text-xl text-teal-100 mb-4">
                Transparency about our technology, data sources, and the boundaries
                of AI-assisted legal information.
              </p>
        ...
        <section className="py-6 bg-amber-50 border-b border-amber-200">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h2 className="font-bold text-navy-900 mb-1">Important: This is Legal Information, Not Legal Advice</h2>
                <p className="text-navy-700 text-sm mb-2">
                  ezLegal.ai gives you general legal information so you can understand your situation.
                  We are not a law firm. Using our service does not create an attorney-client relationship,
                  and your conversations here do not carry attorney-client privilege.
                  For advice on your specific case, court representation, or complex matters, talk to a licensed attorney in your state.
                </p>
                <p className="text-amber-700 text-xs font-medium">
                  <Link to="/trust-center" className="underline hover:text-amber-900 transition-colors">Review our Safe Use Checklist</Link> for tips on protecting your privacy while using AI legal tools.
                </p>
              </div>
            </div>
          </div>
